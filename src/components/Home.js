                          ...
                          <h2 className="list-judul">Daftar Dongeng</h2>
                                <div className="list">
                                        { dongengs.map((dongeng) => (
                                            <motion.div
                                            className="hoverList"
                                            key={dongeng.id_dongeng}
                                            whileHover={{ scale: 1.1 }}
                                            whileTap={{ scale: 0.9 }}
                                            >
                                            <div className="card" >
                                                <Link to={ `/${dongeng.id_dongeng}` }>    
                                                    <img src={gambar1} alt="kancil" className="card-img-top" />
                                            ...
                                            <div className="card 2">
                                                <img src={gambar2} alt="sangkuriang"className="card-img-top" />
                                                <div className="card-body">
                                                    <div className="card-text">
