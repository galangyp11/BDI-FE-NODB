...
import soundChat10 from ".././sound/chat10.mp3";
import bsKancil from ".././sound/bs-kancil-pak-tani.mp3";

const Chat10 = ({ dongengChat10 }) => {
  return (
      ...
      <div className="hal-chat-kancil">
        ...
        >
          ...
          <TypeAnimation
            ...
            cursor={false}
            sequence={[
              "Wah hebat sekali Petani itu, dia terus saja menungguku sambil berdiri di sana. Kalau begini terus aku tidak bisa makan timun hari ini",
              1000,
            ]}
            speed={99}
            wrapper="h3"
